...
import getFreeModelOrder from "@/actions/getFreeModelOrder";
...
const useGetFreeModelOrder = ({ storage }: Params): Return => {
  const query = useQuery({
    queryFn: () => getFreeModelOrder({ storage }),
    queryKey: ["freeModelOrder"],
  });
...
export default useGetFreeModelOrder;
