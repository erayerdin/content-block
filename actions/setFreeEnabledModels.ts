...
const setFreeEnabledModels = async ({
  models,
  storage,
}: Params): Promise<void> => {
  console.log("Setting enabled models...");
  await storage.setItem("sync:freeEnabledModels", models);
};

export default setFreeEnabledModels;
